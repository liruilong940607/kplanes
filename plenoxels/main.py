...
def get_freer_gpu():
    ...
    return (
        None  # The grep doesn't work with all GPUs. If it fails we ignore it.
    )
...
from plenoxels.runners import (
    phototourism_trainer,
    static_trainer,
    video_trainer,
)
from plenoxels.utils.create_rendering import (
    decompose_space_time,
    render_to_path,
)
...
def main():
    ...
    if args.log_dir is not None:
        ...
        trainer.load_model(
            torch.load(checkpoint_path), training_needed=training_needed
        )
